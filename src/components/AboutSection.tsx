...
const AboutSection = () => {
  const sections = [
    ...
    },
    {
      ...
      title: "Global Impact",
      icon: Globe,
      content: `Operating across the Global South, we partner with local communities to ensure our solutions are culturally appropriate. Every intervention is designed with farmers to create lasting, scalable change from the ground up.`,
    },
  ];
